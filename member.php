...
$sql="select acct_id,name,post,email,phone from registration where status='inactive'";
        ...
        while($row=mysqli_fetch_assoc($result))
        {
           ...
           <td><a href="activate.php?t=<?php echo $row['acct_id']?>"><button class="b1">APPROVE</button></a></td>
           <td><a href="remove.php?c=<?php echo $row['acct_id']?>"><button class="b1">REMOVE</button></a></td>
