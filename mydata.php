...
<br>
                    ...
                    <th>ACCOUNT ID </th>
                    <td><?php echo $row['acct_id']?></td></tr><tr>
                    <th>NAME </th>
                    <td><?php echo $row['name']?></td></tr><tr>
                    <th>ADDRESS </th>
                    <td><?php echo $row['hname']?><a href="update.php">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button><font color="red">UPDATE</a></font></button></td></tr><tr>
                    <th>POST</th>
                    <td><?php echo $row['post']?></td></tr><tr>
                    <th>PINCODE</th>
                    <td><?php echo $row['pin']?></td></tr></tr>
                    <th>EMAIL ID</th>
                    <td><?php echo $row['email']?></td></tr><tr>
                    <th>MOBILE NUMBER</th>
