...
<form enctype="multipart/form-data" method="post" class="reservations-box" name="reg" onSubmit = "return checkPassword(this)" action="trackitem.php">

                            <!-- end col -->
                            <!-- end col -->

                          
                 <center> <input type="text" name="trid"  required="ID Required" placeholder="Tracking ID / Order ID" class="tr"></center>
 ...
 -->                   <!--  .......................................................................................... -->
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="reserve-book-btn text-center">
                                    <button  type="submit" value="SEND" id="submit">TRACK STATUS</button>
