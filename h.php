                       ...
                       <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href=viewbooks.php>BUY BOOK</a></li>
...
$sql="select tbbook.book_id,tbbook.book_name,tbbook.author,tbbook.edition,tbbook.publisher,tbbook.pub_year,tbbook.photo,tbbooks.description,tbbooks.price from tbbook,tbbooks where tbbook.book_id=tbbooks.book_id && tbbook.book_id='$t'";
        ...
        while ($row=mysqli_fetch_assoc($result))
        {
            ...
            ?>
                        ...
                        echo "<p> Book Name : ".$row['book_name'];
                        echo "<br>";
                        ...
                        echo "<br>";
                        echo " Published Year : ".$row['pub_year'];
                        echo "<br>";
                        ...
                        ?>
                                   ...
                                   <img src="images/<?php echo $row['photo']?>" id="imag" width="280" height="350">
                            <br>
                            <center><a href="order.php?t=<?php echo $row['book_id']?>"><center><b><font color="red"><br><br><button class="b1"><font color="white">Buy Book</a></button></font></center>
