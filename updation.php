                       ...
                       <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="#our_team">SELL BOOK</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="form-reservations-box">
                    ...
                    $post=$_POST['post'];
                    $pin=$_POST['pin'];
                    $abc=mysqli_query($conn,"update registration set  hname='$hname',post='$post',pin='$pin' where email='$a'");

                if($abc>0)
                  echo '<script>alert("Updation Successfully");window.location.assign("profile.php");</script>';
  
                    else
                    echo '<script>alert("Error While Insertion");window.location.assign("userhome.php");</script>';
                        ?>
                            </table>
                            </form>
                            </div>
