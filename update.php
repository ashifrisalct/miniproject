            ...
            <div class="row">
                <div class="form-reservations-box">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <form method="post" class="reservations-box" name="reg" onSubmit = "return checkPassword(this)"s  action="updation.php" >
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">

                                <div class="form-box">
                                    <input type="text" name="hname"  placeholder="House Name" required="required" data-error="House-Name is required." autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-box">
                                    <input type="text" name="pin"  placeholder="Pincode" required="required" data-error="Pincode is required." autocomplete="off">
                                </div>
                            </div>
 ...
 -->                   <!--  .......................................................................................... -->
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="reserve-book-btn text-center">
                                    <button  type="submit" value="SEND" id="submit">Update </button>
