...
$sql="select tbbook.book_id,tbbook.book_name,tbbook.author,tbbook.edition,tbbook.publisher,tbbook.pub_year,tbbook.photo,tbbooks.description,tbbooks.price from tbbook,tbbooks where tbbook.book_id=tbbooks.book_id && tbbook.book_id='$t' && tbbook.status='ok'";
