...
<br>
                    ...
                    $sql="select tblorder.status,tblorder.order_no,tblorder.book_id,tblorder.order_date,tbbook.book_name from tblorder,tbbook where tblorder.book_id=tbbook.book_id && tbbook.acct_id='$a' && tblorder.status='Not Processed'";
                    ...
                    <td><a href="reciept.php?t=<?php echo $row['order_no']?>"><button class="b1"><font color="white">View And Process</a></font></button></td>
