...
Your Book Orders Status
                    ...
                    $sql="select tblorder.order_no,tblorder.order_date,tblorder.itemstatus,tbbook.book_name,tblorder.status from tblorder,tbbook where tblorder.acc_id='$a' && tbbook.book_id=tblorder.book_id" ;
